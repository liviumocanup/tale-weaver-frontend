...
import 'package:tale_weaver/views/auth/sign_up/components/auth_validators.dart';
...
class _RegistrationFormState extends State<RegistrationForm> {
  ...
  void initState() {
    ...
    focusCallbacks = {
      ...
      usernameFocusNode: () =>
          _onFocusChange(usernameFocusNode, usernameString),
      passwordFocusNode: () =>
          _onFocusChange(passwordFocusNode, passwordString),
      repeatPasswordFocusNode: () =>
          _onFocusChange(repeatPasswordFocusNode, repeatPassString),
    };
    ...
    repeatPasswordFocusNode
        .addListener(focusCallbacks[repeatPasswordFocusNode]!);
  }
  ...
  void dispose() {
    ...
    repeatPasswordFocusNode
        .removeListener(focusCallbacks[repeatPasswordFocusNode]!);
